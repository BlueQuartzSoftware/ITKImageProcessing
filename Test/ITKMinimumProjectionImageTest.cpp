...
public:
  ...
  int TestITKMinimumProjectionImagedefaultsTest()
  {
    ...
    WriteImage("ITKMinimumProjectionImagedefaults.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKMinimumProjectionImageanother_dimensionTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKMinimumProjectionImageanother_dimension.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
  ...
  int TestITKMinimumProjectionImageshort_imageTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKMinimumProjectionImageshort_image.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
  ...
  int TestITKMinimumProjectionImagergb_imageTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKMinimumProjectionImagergb_image.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
