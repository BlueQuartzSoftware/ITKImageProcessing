...
public:
  ...
  int TestITKDoubleThresholdImageDoubleThreshold1Test()
  {
    ...
    WriteImage("ITKDoubleThresholdImageDoubleThreshold1.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKDoubleThresholdImageDoubleThreshold2Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKDoubleThresholdImageDoubleThreshold2.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
