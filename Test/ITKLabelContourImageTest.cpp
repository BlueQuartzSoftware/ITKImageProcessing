...
private:
  ITKLabelContourImageTest(const ITKLabelContourImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKLabelContourImageTest&) = delete;           // Move assignment Not Implemented
};
