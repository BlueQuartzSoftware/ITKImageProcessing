...
public:
  ...
  int TestITKBinaryMinMaxCurvatureFlowImagedefaultsTest()
  {
    ...
    WriteImage("ITKBinaryMinMaxCurvatureFlowImagedefaults.nrrd", containerArray, output_path);
  ...
  int TestITKBinaryMinMaxCurvatureFlowImagelongerTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKBinaryMinMaxCurvatureFlowImagelonger.nrrd", containerArray, output_path);
...
private:
  ITKBinaryMinMaxCurvatureFlowImageTest(const ITKBinaryMinMaxCurvatureFlowImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKBinaryMinMaxCurvatureFlowImageTest&) = delete;                        // Move assignment Not Implemented
};
