...
public:
  ...
  int TestITKMinMaxCurvatureFlowImagedefaultsTest()
  {
    ...
    WriteImage("ITKMinMaxCurvatureFlowImagedefaults.nrrd", containerArray, output_path);
  ...
  int TestITKMinMaxCurvatureFlowImagelongerTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKMinMaxCurvatureFlowImagelonger.nrrd", containerArray, output_path);
