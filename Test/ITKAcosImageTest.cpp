...
class ITKAcosImageTest
{

  public:
    ITKAcosImageTest() {}
    virtual ~ITKAcosImageTest() {}
  ...
  {
    // Now instantiate the ITKAcosImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKAcosImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKAcosImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKAcosImageTest::TestFile1
//    * UnitTest::ITKAcosImageTest::TestFile2
//    *
...
int TestITKAcosImagedefaultsTest()
{
    ...
    WriteImage("ITKAcosImagedefaults.nrrd", containerArray, input_path);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKAcosImageTest() )
  ...
  private:
    ...
    void operator=(const ITKAcosImageTest&); // Operator '=' Not Implemented
