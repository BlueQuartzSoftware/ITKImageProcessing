...
public:
  ITKNotImageTest() = default;
  ~ITKNotImageTest() override = default;
  ...
  int TestITKNotImagedefaultsTest()
  {
    ...
    WriteImage("ITKNotImagedefaults.nrrd", containerArray, output_path);
    QString md5Output;
...
private:
  ITKNotImageTest(const ITKNotImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKNotImageTest&) = delete;  // Move assignment Not Implemented
};
