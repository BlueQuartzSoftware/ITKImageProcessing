...
private:
  ITKHistogramMatchingImageTest(const ITKHistogramMatchingImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKHistogramMatchingImageTest&) = delete;                // Move assignment Not Implemented
};
