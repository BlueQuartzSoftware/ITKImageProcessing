...
public:
  ...
  int TestITKIntensityWindowingImage2dTest()
  {
    ...
    WriteImage("ITKIntensityWindowingImage2d.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKIntensityWindowingImage3dFloatTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKIntensityWindowingImage3dFloat.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
  ...
  int TestITKIntensityWindowingImage3dShortTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKIntensityWindowingImage3dShort.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
