...
public:
  ...
  int TestITKPatchBasedDenoisingImagedefaultTest()
  {
    ...
    WriteImage("ITKPatchBasedDenoisingImagedefault.nrrd", containerArray, output_path);
    ...
    int res = this->CompareImages(containerArray, output_path, baseline_path, 0.9);
...
private:
  ITKPatchBasedDenoisingImageTest(const ITKPatchBasedDenoisingImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKPatchBasedDenoisingImageTest&) = delete;                  // Move assignment Not Implemented
};
