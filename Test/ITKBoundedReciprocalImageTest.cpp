...
public:
  ...
  int TestITKBoundedReciprocalImagedefaultsTest()
  {
    ...
    WriteImage("ITKBoundedReciprocalImagedefaults.nrrd", containerArray, output_path);
  ...
  int TestITKBoundedReciprocalImagevectorTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKBoundedReciprocalImagevector.nrrd", containerArray, output_path);
