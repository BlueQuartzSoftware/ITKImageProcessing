...
public:
  ...
  int TestITKGrayscaleGrindPeakImageGrayscaleGrindPeak1Test()
  {
    ...
    WriteImage("ITKGrayscaleGrindPeakImageGrayscaleGrindPeak1.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKGrayscaleGrindPeakImageGrayscaleGrindPeak2Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKGrayscaleGrindPeakImageGrayscaleGrindPeak2.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
