...
public:
  ...
  int TestITKThresholdImageDefaultTest()
  {
    ...
    WriteImage("ITKThresholdImageDefault.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKThresholdImageThreshold1Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKThresholdImageThreshold1.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
  ...
  int TestITKThresholdImageThreshold2Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKThresholdImageThreshold2.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
