...
public:
  ITKValuedRegionalMinimaImageTest() = default;
  ~ITKValuedRegionalMinimaImageTest() override = default;
  ...
  int TestITKValuedRegionalMinimaImagedefaultsTest()
  {
    ...
    WriteImage("ITKValuedRegionalMinimaImagedefaults.nrrd", containerArray, output_path);
    QString md5Output;
...
private:
  ITKValuedRegionalMinimaImageTest(const ITKValuedRegionalMinimaImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKValuedRegionalMinimaImageTest&) = delete;                   // Move assignment Not Implemented
};
