...
public:
  ...
  int TestITKStandardDeviationProjectionImagez_projectionTest()
  {
    ...
    QString filtName = "ITKStandardDeviationProjectionImage";
    ...
    WriteImage("ITKStandardDeviationProjectionImagez_projection.nrrd", containerArray, output_path);
    QString baseline_filename = UnitTest::DataDir + QString("/Data/JSONFilters/Baseline/BasicFilters_StandardDeviationProjectionImageFilter_z_projection.nrrd");
...
private:
  ITKStandardDeviationProjectionImageTest(const ITKStandardDeviationProjectionImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKStandardDeviationProjectionImageTest&) = delete;                          // Move assignment Not Implemented
};
