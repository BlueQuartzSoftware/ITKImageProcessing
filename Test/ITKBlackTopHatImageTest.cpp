...
public:
  ITKBlackTopHatImageTest() = default;
  ~ITKBlackTopHatImageTest() override = default;
  ...
  int TestITKBlackTopHatImageBlackTopHapErodeTest()
  {
    ...
    WriteImage("ITKBlackTopHatImageBlackTopHapErode.nrrd", containerArray, output_path);
    QString md5Output;
...
private:
  ITKBlackTopHatImageTest(const ITKBlackTopHatImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKBlackTopHatImageTest&) = delete;          // Move assignment Not Implemented
};
