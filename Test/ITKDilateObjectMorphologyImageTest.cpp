...
public:
  ...
  int TestITKDilateObjectMorphologyImagefloatTest()
  {
    ...
    WriteImage("ITKDilateObjectMorphologyImagefloat.nrrd", containerArray, output_path);
  ...
  int TestITKDilateObjectMorphologyImageshortTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKDilateObjectMorphologyImageshort.nrrd", containerArray, output_path);
...
private:
  ITKDilateObjectMorphologyImageTest(const ITKDilateObjectMorphologyImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKDilateObjectMorphologyImageTest&) = delete;                     // Move assignment Not Implemented
};
