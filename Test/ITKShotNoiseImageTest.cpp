...
public:
  ...
  int TestITKShotNoiseImage2dTest()
  {
    ...
    WriteImage("ITKShotNoiseImage2d.nrrd", containerArray, output_path);
    ...
    int res = this->CompareImages(containerArray, output_path, baseline_path, 500.0);
  ...
  int TestITKShotNoiseImage3dTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKShotNoiseImage3d.nrrd", containerArray, output_path);
  ...
  int TestITKShotNoiseImagergbTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >=, 0);
    WriteImage("ITKShotNoiseImagergb.nrrd", containerArray, output_path);
...
private:
  ITKShotNoiseImageTest(const ITKShotNoiseImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKShotNoiseImageTest&) = delete;        // Operator '=' Not Implemented
};
