...
private:
  ITKInvertIntensityImageTest(const ITKInvertIntensityImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKInvertIntensityImageTest&) = delete;              // Move assignment Not Implemented
};
