...
class ITKSigmoidImageTest
{
  ...
  {
    // Now instantiate the ITKSigmoidImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKSigmoidImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKSigmoidImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKSigmoidImageTest::TestFile1
//    * UnitTest::ITKSigmoidImageTest::TestFile2
//    *
...
int TestITKSigmoidImagedefaultsTest()
{
    ...
    WriteImage("ITKSigmoidImagedefaults.nrrd", containerArray, input_path);
    QString md5Output;
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKSigmoidImageTest() )
