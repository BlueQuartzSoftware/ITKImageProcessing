...
public:
  ...
  int TestITKGradientAnisotropicDiffusionImagedefaultsTest()
  {
    ...
    WriteImage("ITKGradientAnisotropicDiffusionImagedefaults.nrrd", containerArray, output_path);
    ...
    int res = this->CompareImages(containerArray, output_path, baseline_path, 0);
  ...
  int TestITKGradientAnisotropicDiffusionImagelongerTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKGradientAnisotropicDiffusionImagelonger.nrrd", containerArray, output_path);
