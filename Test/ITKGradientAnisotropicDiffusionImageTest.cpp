...
class ITKGradientAnisotropicDiffusionImageTest
{
  ...
  {
    // Now instantiate the ITKGradientAnisotropicDiffusionImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKGradientAnisotropicDiffusionImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKGradientAnisotropicDiffusionImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKGradientAnisotropicDiffusionImageTest::TestFile1
//    * UnitTest::ITKGradientAnisotropicDiffusionImageTest::TestFile2
//    *
...
int TestITKGradientAnisotropicDiffusionImagedefaultsTest()
{
    ...
    int res = CompareImages(containerArray, input_path, baseline_path, 0);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKGradientAnisotropicDiffusionImageTest() )
