...
public:
  ...
  int TestITKBinaryMorphologicalClosingImageBinaryMorphologicalClosingTest()
  {
    ...
    WriteImage("ITKBinaryMorphologicalClosingImageBinaryMorphologicalClosing.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKBinaryMorphologicalClosingImageBinaryMorphologicalClosingWithBorderTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKBinaryMorphologicalClosingImageBinaryMorphologicalClosingWithBorder.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
...
private:
  ITKBinaryMorphologicalClosingImageTest(const ITKBinaryMorphologicalClosingImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKBinaryMorphologicalClosingImageTest&) = delete;                         // Move assignment Not Implemented
};
