...
public:
  ITKSquareImageTest() = default;
  ~ITKSquareImageTest() override = default;
  ...
  int TestITKSquareImagedefaultsTest()
  {
    ...
    WriteImage("ITKSquareImagedefaults.nrrd", containerArray, output_path);
    QString md5Output;
...
private:
  ITKSquareImageTest(const ITKSquareImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKSquareImageTest&) = delete;     // Move assignment Not Implemented
};
