...
class ITKWhiteTopHatImageTest : public ITKTestBase
{
...
public:
  ...
  int TestITKWhiteTopHatImageWhiteTopHatErodeTest()
  {
    ...
    QString filtName = "ITKWhiteTopHatImage";
    ...
    WriteImage("ITKWhiteTopHatImageWhiteTopHatErode.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
    DREAM3D_REQUIRE_EQUAL(QString(md5Output), QString("e784daff43d09a18e20556729afc0c9d"));
    return 0;
  }
  ...
  void operator()() override
  {
    ...
    DREAM3D_REGISTER_TEST(this->TestFilterAvailability("ITKWhiteTopHatImage"));

    DREAM3D_REGISTER_TEST(TestITKWhiteTopHatImageWhiteTopHatErodeTest());
...
private:
  ITKWhiteTopHatImageTest(const ITKWhiteTopHatImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKWhiteTopHatImageTest&) = delete;          // Move assignment Not Implemented
};
