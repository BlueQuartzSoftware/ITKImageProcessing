...
public:
  ...
  int TestITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpeningTest()
  {
    ...
    WriteImage("ITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpening.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpeningVectorRadius1Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpeningVectorRadius1.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
  ...
  int TestITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpeningVectorRadius2Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKGrayscaleMorphologicalOpeningImageGrayscaleMorphologicalOpeningVectorRadius2.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
...
private:
  ITKGrayscaleMorphologicalOpeningImageTest(const ITKGrayscaleMorphologicalOpeningImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKGrayscaleMorphologicalOpeningImageTest&) = delete;                            // Move assignment Not Implemented
};
