...
public:
  ...
  int TestITKCurvatureFlowImagedefaultsTest()
  {
    ...
    QString filtName = "ITKCurvatureFlowImage";
    ...
    WriteImage("ITKCurvatureFlowImagedefaults.nrrd", containerArray, output_path);
  ...
  int TestITKCurvatureFlowImagelongerTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKCurvatureFlowImagelonger.nrrd", containerArray, output_path);
