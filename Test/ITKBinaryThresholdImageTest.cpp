...
public:
  ...
  int TestITKBinaryThresholdImagedefaultTest()
  {
    ...
    WriteImage("ITKBinaryThresholdImagedefault.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKBinaryThresholdImageNarrowThresholdTest()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKBinaryThresholdImageNarrowThreshold.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
