...
class ITKLogImageTest
{

  public:
    ITKLogImageTest() {}
    virtual ~ITKLogImageTest() {}
  ...
  {
    // Now instantiate the ITKLogImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKLogImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKLogImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKLogImageTest::TestFile1
//    * UnitTest::ITKLogImageTest::TestFile2
//    *
...
int TestITKLogImagedefaultsTest()
{
    ...
    WriteImage("ITKLogImagedefaults.nrrd", containerArray, input_path);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKLogImageTest() )
  ...
  private:
    ITKLogImageTest(const ITKLogImageTest&); // Copy Constructor Not Implemented
    void operator=(const ITKLogImageTest&); // Operator '=' Not Implemented
