...
class ITKSpeckleNoiseImageTest
{
  ...
  {
    // Now instantiate the ITKSpeckleNoiseImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKSpeckleNoiseImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKSpeckleNoiseImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKSpeckleNoiseImageTest::TestFile1
//    * UnitTest::ITKSpeckleNoiseImageTest::TestFile2
//    *
...
int TestITKSpeckleNoiseImage2dTest()
{
    ...
    int res = CompareImages(containerArray, input_path, baseline_path, 100.0);
...
int TestITKSpeckleNoiseImage3dTest()
{
    ...
    DataArrayPath baseline_path("BContainer", "BAttributeMatrixName", "BAttributeArrayName");
    ReadImage(baseline_filename, containerArray, baseline_path);
    int res = CompareImages(containerArray, input_path, baseline_path, 200000.0);
    DREAM3D_REQUIRE_EQUAL(res,0);
    return 0;
}
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKSpeckleNoiseImageTest() )
