...
class ITKCurvatureAnisotropicDiffusionImageTest
{
  ...
  {
    // Now instantiate the ITKCurvatureAnisotropicDiffusionImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKCurvatureAnisotropicDiffusionImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKCurvatureAnisotropicDiffusionImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKCurvatureAnisotropicDiffusionImageTest::TestFile1
//    * UnitTest::ITKCurvatureAnisotropicDiffusionImageTest::TestFile2
//    *
...
int TestITKCurvatureAnisotropicDiffusionImagedefaultsTest()
{
    ...
    WriteImage("ITKCurvatureAnisotropicDiffusionImagedefaults.nrrd", containerArray, input_path);
    ...
    int res = CompareImages(containerArray, input_path, baseline_path, 0.1);
...
int TestITKCurvatureAnisotropicDiffusionImagelongerTest()
{
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >= , 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >= , 0);
    WriteImage("ITKCurvatureAnisotropicDiffusionImagelonger.nrrd", containerArray, input_path);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKCurvatureAnisotropicDiffusionImageTest() )
