...
class ITKSqrtImageTest
{
  ...
  {
    // Now instantiate the ITKSqrtImageTest Filter from the FilterManager
    QString filtName = "ITKSqrtImage";
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKSqrtImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKSqrtImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKSqrtImageTest::TestFile1
//    * UnitTest::ITKSqrtImageTest::TestFile2
//    *
...
int TestITKSqrtImagedefaultsTest()
{
    ...
    WriteImage("ITKSqrtImagedefaults.nrrd", containerArray, input_path);
    QString baseline_filename = UnitTest::DataDir + QString("/Data/JSONFilters/Baseline/BasicFilters_SqrtImageFilter_defaults.nrrd");
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKSqrtImageTest() )
    DREAM3D_REGISTER_TEST( TestITKSqrtImagedefaultsTest());
  ...
  private:
    ...
    void operator=(const ITKSqrtImageTest&); // Operator '=' Not Implemented
