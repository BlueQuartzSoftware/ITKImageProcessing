...
public:
  ...
  int TestITKGrayscaleFillholeImageGrayscaleFillhole1Test()
  {
    ...
    WriteImage("ITKGrayscaleFillholeImageGrayscaleFillhole1.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKGrayscaleFillholeImageGrayscaleFillhole2Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKGrayscaleFillholeImageGrayscaleFillhole2.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
