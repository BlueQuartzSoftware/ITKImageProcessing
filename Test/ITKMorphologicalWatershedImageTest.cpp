...
public:
  ...
  int TestITKMorphologicalWatershedImagedefaultsTest()
  {
    ...
    WriteImage("ITKMorphologicalWatershedImagedefaults.nrrd", containerArray, output_path);
    QString md5Output;
  ...
  int TestITKMorphologicalWatershedImagelevel_1Test()
  {
    ...
    DREAM3D_REQUIRED(filter->getErrorCode(), >=, 0);
    DREAM3D_REQUIRED(filter->getWarningCode(), >=, 0);
    WriteImage("ITKMorphologicalWatershedImagelevel_1.nrrd", containerArray, output_path);
    QString md5Output;
    GetMD5FromDataContainer(containerArray, output_path, md5Output);
