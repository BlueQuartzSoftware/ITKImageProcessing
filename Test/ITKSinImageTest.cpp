...
class ITKSinImageTest
{
  ...
  {
    // Now instantiate the ITKSinImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKSinImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKSinImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKSinImageTest::TestFile1
//    * UnitTest::ITKSinImageTest::TestFile2
//    *
...
int TestITKSinImagedefaultsTest()
{
    ...
    WriteImage("ITKSinImagedefaults.nrrd", containerArray, input_path);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKSinImageTest() )
  ...
  private:
    ...
    void operator=(const ITKSinImageTest&); // Operator '=' Not Implemented
