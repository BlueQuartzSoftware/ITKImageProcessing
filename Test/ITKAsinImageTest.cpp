...
public:
  ITKAsinImageTest() = default;
  ~ITKAsinImageTest() override = default;
  ...
  int TestITKAsinImagedefaultsTest()
  {
    ...
    WriteImage("ITKAsinImagedefaults.nrrd", containerArray, output_path);
...
private:
  ITKAsinImageTest(const ITKAsinImageTest&) = delete; // Copy Constructor Not Implemented
  void operator=(const ITKAsinImageTest&) = delete;   // Move assignment Not Implemented
};
