...
class ITKAbsImageTest
{
  ...
  {
    // Now instantiate the ITKAbsImageTest Filter from the FilterManager
...
//  //
//  // -----------------------------------------------------------------------------
//  int TestITKAbsImageTest()
//  {
//    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//   /* Please write ITKAbsImageTest test code here.
//    *
//    * Your IO test files are:
//    * UnitTest::ITKAbsImageTest::TestFile1
//    * UnitTest::ITKAbsImageTest::TestFile2
//    *
...
int TestITKAbsImagefloatTest()
{
    ...
    WriteImage("ITKAbsImagefloat.nrrd", containerArray, input_path);
...
int TestITKAbsImageshortTest()
{
    ...
    DREAM3D_REQUIRED(filter->getErrorCondition(), >= , 0);
    DREAM3D_REQUIRED(filter->getWarningCondition(), >= , 0);
    WriteImage("ITKAbsImageshort.nrrd", containerArray, input_path);
                 ...
                 QString &md5)
{
  ...
  void operator()()
  {
    ...
    //DREAM3D_REGISTER_TEST( TestITKAbsImageTest() )
