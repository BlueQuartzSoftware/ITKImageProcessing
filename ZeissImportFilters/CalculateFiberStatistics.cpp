...
#include "CalculateFiberStatistics.h"
...
//
// -----------------------------------------------------------------------------
CalculateFiberStatistics::CalculateFiberStatistics() :
  AbstractFilter()
...
//
// -----------------------------------------------------------------------------
void CalculateFiberStatistics::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void CalculateFiberStatistics::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
int CalculateFiberStatistics::writeFilterParameters(AbstractFilterParametersWriter* writer, int index)
{
...
//
// -----------------------------------------------------------------------------
void CalculateFiberStatistics::dataCheck()
{
  setErrorCondition(0);
...
//
// -----------------------------------------------------------------------------
void CalculateFiberStatistics::preflight()
{
...
//
// -----------------------------------------------------------------------------
const QString CalculateFiberStatistics::getCompiledLibraryName()
{
...
//
// -----------------------------------------------------------------------------
const QString CalculateFiberStatistics::getGroupName()
{
  return "ZeissImport";
}
...
//
// -----------------------------------------------------------------------------
const QString CalculateFiberStatistics::getHumanLabel()
{
  return "CalculateFiberStatistics";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString CalculateFiberStatistics::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
void CalculateFiberStatistics::execute()
{
  int err = 0;
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer CalculateFiberStatistics::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  CalculateFiberStatistics::Pointer filter = CalculateFiberStatistics::New();
