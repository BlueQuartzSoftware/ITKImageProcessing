...
#ifndef _FindFiberEdges_H_
#define _FindFiberEdges_H_
...
/**
 * @class FindFiberEdges FindFiberEdges.h ZeissImport/ZeissImportFilters/FindFiberEdges.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class FindFiberEdges : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(FindFiberEdges)
    DREAM3D_STATIC_NEW_MACRO(FindFiberEdges)
    DREAM3D_TYPE_MACRO_SUPER(FindFiberEdges, AbstractFilter)

    virtual ~FindFiberEdges();
  ...
  private:
    ...
    FindFiberEdges(const FindFiberEdges&); // Copy Constructor Not Implemented
    void operator=(const FindFiberEdges&); // Operator '=' Not Implemented
};

#endif /* _FindFiberEdges_H_ */
