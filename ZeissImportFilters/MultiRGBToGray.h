...
#ifndef _MultiRGBToGray_H_
#define _MultiRGBToGray_H_
...
/**
 * @class MultiRGBToGray MultiRGBToGray.h ZeissImport/ZeissImportFilters/MultiRGBToGray.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class MultiRGBToGray : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(MultiRGBToGray)
    DREAM3D_STATIC_NEW_MACRO(MultiRGBToGray)
    DREAM3D_TYPE_MACRO_SUPER(MultiRGBToGray, AbstractFilter)

    virtual ~MultiRGBToGray();
  ...
  private:
    ...
    MultiRGBToGray(const MultiRGBToGray&); // Copy Constructor Not Implemented
    void operator=(const MultiRGBToGray&); // Operator '=' Not Implemented
};

#endif /* _MultiRGBToGray_H_ */
