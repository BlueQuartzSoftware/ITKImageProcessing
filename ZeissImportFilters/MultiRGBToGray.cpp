...
//
// -----------------------------------------------------------------------------
void MultiRGBToGray::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void MultiRGBToGray::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
int MultiRGBToGray::writeFilterParameters(AbstractFilterParametersWriter* writer, int index)
{
...
//
// -----------------------------------------------------------------------------
const QString MultiRGBToGray::getCompiledLibraryName()
{
...
//
// -----------------------------------------------------------------------------
const QString MultiRGBToGray::getGroupName()
{
  return "ZeissImport";
}
...
//
// -----------------------------------------------------------------------------
const QString MultiRGBToGray::getHumanLabel()
{
  return "MultiRGBToGray";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString MultiRGBToGray::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer MultiRGBToGray::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  MultiRGBToGray::Pointer filter = MultiRGBToGray::New();
