...
//
// -----------------------------------------------------------------------------
void FindFiberEdges::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void FindFiberEdges::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
int FindFiberEdges::writeFilterParameters(AbstractFilterParametersWriter* writer, int index)
{
...
//
// -----------------------------------------------------------------------------
const QString FindFiberEdges::getCompiledLibraryName()
{
...
//
// -----------------------------------------------------------------------------
const QString FindFiberEdges::getGroupName()
{
  return "ZeissImport";
}
...
//
// -----------------------------------------------------------------------------
const QString FindFiberEdges::getHumanLabel()
{
  return "FindFiberEdges";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString FindFiberEdges::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer FindFiberEdges::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  FindFiberEdges::Pointer filter = FindFiberEdges::New();
