...
//
// -----------------------------------------------------------------------------
EMMPMSegmentation::EMMPMSegmentation() :
  AbstractFilter()
...
//
// -----------------------------------------------------------------------------
void EMMPMSegmentation::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void EMMPMSegmentation::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
int EMMPMSegmentation::writeFilterParameters(AbstractFilterParametersWriter* writer, int index)
{
...
//
// -----------------------------------------------------------------------------
void EMMPMSegmentation::dataCheck()
{
  setErrorCondition(0);
...
//
// -----------------------------------------------------------------------------
void EMMPMSegmentation::preflight()
{
...
//
// -----------------------------------------------------------------------------
const QString EMMPMSegmentation::getCompiledLibraryName()
{
...
//
// -----------------------------------------------------------------------------
const QString EMMPMSegmentation::getGroupName()
{
  return "ZeissImport";
}
...
//
// -----------------------------------------------------------------------------
const QString EMMPMSegmentation::getHumanLabel()
{
  return "EMMPMSegmentation";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString EMMPMSegmentation::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
void EMMPMSegmentation::execute()
{
  int err = 0;
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer EMMPMSegmentation::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  EMMPMSegmentation::Pointer filter = EMMPMSegmentation::New();
