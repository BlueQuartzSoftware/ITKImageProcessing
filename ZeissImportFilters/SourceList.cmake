...
foreach(f ${_PublicFilters} )
  ADD_SIMPL_FILTER(  "ZeissImport" "ZeissImport"
                        ${_filterGroupName} ${f}
                        ${ZeissImport_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE ${ZeissImport_BINARY_DIR})
endforeach()
...
SIMPL_END_FILTER_GROUP(${ZeissImport_BINARY_DIR} "${_filterGroupName}" "ZeissImport")
