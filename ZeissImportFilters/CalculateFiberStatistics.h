...
#ifndef _CalculateFiberStatistics_H_
#define _CalculateFiberStatistics_H_
...
/**
 * @class CalculateFiberStatistics CalculateFiberStatistics.h ZeissImport/ZeissImportFilters/CalculateFiberStatistics.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class CalculateFiberStatistics : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(CalculateFiberStatistics)
    DREAM3D_STATIC_NEW_MACRO(CalculateFiberStatistics)
    DREAM3D_TYPE_MACRO_SUPER(CalculateFiberStatistics, AbstractFilter)

    virtual ~CalculateFiberStatistics();
  ...
  private:
    ...
    CalculateFiberStatistics(const CalculateFiberStatistics&); // Copy Constructor Not Implemented
    void operator=(const CalculateFiberStatistics&); // Operator '=' Not Implemented
};

#endif /* _CalculateFiberStatistics_H_ */
