...
//
// -----------------------------------------------------------------------------
int CalculateBackground::readMetaXml(QIODevice* device)
{
  int err = 0;
...
//
// -----------------------------------------------------------------------------
ZeissTagsXmlSection::Pointer CalculateBackground::parseTagsSection(QDomElement& tags)
{
  int count = -1;
  bool ok = false;
...
//
// -----------------------------------------------------------------------------
void CalculateBackground::parseImages(QDomElement& root, ZeissTagsXmlSection::Pointer rootTagsSection)
{
...
//
// -----------------------------------------------------------------------------
void CalculateBackground::generateDataArrays(const QString &imageName, const QString &pTag, const QString &dcName)
{
...
//
// -----------------------------------------------------------------------------
void CalculateBackground::setDataContainerDims(VolumeDataContainer* dc, ZeissTagsXmlSection::Pointer photoTagsSection)
{
