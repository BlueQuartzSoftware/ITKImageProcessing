...
#ifndef _EMMPMSegmentation_H_
#define _EMMPMSegmentation_H_
...
/**
 * @class EMMPMSegmentation EMMPMSegmentation.h ZeissImport/ZeissImportFilters/EMMPMSegmentation.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class EMMPMSegmentation : public AbstractFilter
{
  Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(EMMPMSegmentation)
    DREAM3D_STATIC_NEW_MACRO(EMMPMSegmentation)
    DREAM3D_TYPE_MACRO_SUPER(EMMPMSegmentation, AbstractFilter)

    virtual ~EMMPMSegmentation();
  ...
  private:
    ...
    EMMPMSegmentation(const EMMPMSegmentation&); // Copy Constructor Not Implemented
    void operator=(const EMMPMSegmentation&); // Operator '=' Not Implemented
};

#endif /* _EMMPMSegmentation_H_ */
