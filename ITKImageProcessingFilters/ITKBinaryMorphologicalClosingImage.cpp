...
void ITKBinaryMorphologicalClosingImage::dataCheck()
{
  ...
  // All integer types
  supportedTypes << "uint8_t"<< "int8_t"<< "uint16_t"<<"int16_t"
                 << "uint_32_t" << "int32_t" << "uint64_t" << "int64_t";
...
{ return "ITK::Binary Morphological Closing Image Filter (KW)"; }

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString ITKBinaryMorphologicalClosingImage::getSubGroupName()
