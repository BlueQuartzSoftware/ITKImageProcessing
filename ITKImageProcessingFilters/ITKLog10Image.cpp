...
void ITKLog10Image::CheckIntegerEntry(SubsType value, QString name)
{
...
//
// -----------------------------------------------------------------------------
void ITKLog10Image::dataCheckInternal()
{
...
void ITKLog10Image::filter()
{
  ...
  //define filter
  typedef itk::Log10ImageFilter<ImageType, ImageType> FilterType;
