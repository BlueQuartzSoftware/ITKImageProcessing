 ...
 */
class ITKImageProcessing_EXPORT ITKExpImage : public ITKImageProcessingBase
{
  Q_OBJECT

public:
    using Self = ITKExpImage;
    ...
    static std::shared_ptr<ITKExpImage> New();

    /**
    * @brief Returns the name of the class for ITKExpImage
    */
...
public:
  ...
  ITKExpImage& operator=(ITKExpImage&&) = delete;      // Move Assignment Not Implemented
