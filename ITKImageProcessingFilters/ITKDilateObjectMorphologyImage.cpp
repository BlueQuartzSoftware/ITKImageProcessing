...
#include "ITKDilateObjectMorphologyImage.h"
...
void ITKDilateObjectMorphologyImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKDilateObjectMorphologyImage::filter()
{
  ...
  //define filter
  typedef itk::DilateObjectMorphologyImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Dilate Object Morphology Image Filter (KW)"; }
