...
void ITKWhiteTopHatImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKWhiteTopHatImage::filter()
{
  ...
  //define filter
  typedef itk::WhiteTopHatImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  White Top Hat Image Filter (KW)"; }
