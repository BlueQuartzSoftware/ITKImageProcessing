...
#include "ITKClosingByReconstructionImage.h"
...
#include "moc_ITKClosingByReconstructionImage.cpp"
...
void ITKClosingByReconstructionImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKClosingByReconstructionImage::filter()
{
  ...
  //define filter
  typedef itk::ClosingByReconstructionImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Closing By Reconstruction Image Filter (KW)"; }
