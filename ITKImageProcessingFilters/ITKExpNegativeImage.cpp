...
#include "moc_ITKExpNegativeImage.cpp"
...
void ITKExpNegativeImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKExpNegativeImage::filter()
{
  ...
  //define filter
  typedef itk::ExpNegativeImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Exp Negative Image Filter (KW)"; }
