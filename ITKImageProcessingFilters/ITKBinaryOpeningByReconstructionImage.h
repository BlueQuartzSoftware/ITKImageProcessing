 ...
 */
class ITKBinaryOpeningByReconstructionImage : public ITKImageBase
{
  Q_OBJECT
  ...
  public:
    ...
    SIMPL_TYPE_MACRO_SUPER(ITKBinaryOpeningByReconstructionImage, AbstractFilter)
  ...
  private:
    ...
    ITKBinaryOpeningByReconstructionImage(const ITKBinaryOpeningByReconstructionImage&); // Copy Constructor Not Implemented
