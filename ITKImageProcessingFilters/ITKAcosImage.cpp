...
void ITKAcosImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKAcosImage::filter()
{
  ...
  //define filter
  typedef itk::AcosImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Acos Image Filter (KW)"; }
