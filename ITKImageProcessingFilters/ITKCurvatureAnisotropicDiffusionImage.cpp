...
void ITKCurvatureAnisotropicDiffusionImage::setupFilterParameters()
{
  ...
  parameters.push_back(SIMPL_NEW_FLOAT_FP("TimeStep", TimeStep, FilterParameter::Parameter, ITKCurvatureAnisotropicDiffusionImage));
  parameters.push_back(SIMPL_NEW_FLOAT_FP("ConductanceParameter", ConductanceParameter, FilterParameter::Parameter, ITKCurvatureAnisotropicDiffusionImage));
  parameters.push_back(SIMPL_NEW_FLOAT_FP("ConductanceScalingUpdateInterval", ConductanceScalingUpdateInterval, FilterParameter::Parameter, ITKCurvatureAnisotropicDiffusionImage));
  parameters.push_back(SIMPL_NEW_FLOAT_FP("NumberOfIterations", NumberOfIterations, FilterParameter::Parameter, ITKCurvatureAnisotropicDiffusionImage));
