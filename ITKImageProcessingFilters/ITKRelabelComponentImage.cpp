...
void ITKRelabelComponentImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKRelabelComponentImage::dataCheck()
{
  ...
  CheckIntegerEntry<uint64_t,double>(m_MinimumObjectSize, "MinimumObjectSize");
