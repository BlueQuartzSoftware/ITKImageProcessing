...
void ITKTanImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKTanImage::filter()
{
  ...
  //define filter
  typedef itk::TanImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Tan Image Filter (KW)"; }
