...
#include "moc_ITKMorphologicalWatershedImage.cpp"
...
void ITKMorphologicalWatershedImage::CheckIntegerEntry(SubsType value, QString name)
{
...
{ return "[ITK] ITK  Morphological Watershed Image Filter (KW)"; }
