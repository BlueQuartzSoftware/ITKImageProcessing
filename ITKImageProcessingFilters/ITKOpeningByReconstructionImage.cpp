...
#include "moc_ITKOpeningByReconstructionImage.cpp"
...
void ITKOpeningByReconstructionImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKOpeningByReconstructionImage::filter()
{
  ...
  //define filter
  typedef itk::OpeningByReconstructionImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Opening By Reconstruction Image Filter (KW)"; }
