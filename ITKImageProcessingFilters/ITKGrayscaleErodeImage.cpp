...
#include "ITKGrayscaleErodeImage.h"
...
#include "moc_ITKGrayscaleErodeImage.cpp"
...
void ITKGrayscaleErodeImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKGrayscaleErodeImage::filter()
{
  ...
  //define filter
  typedef itk::GrayscaleErodeImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Grayscale Erode Image Filter (KW)"; }
