...
m_DomainSigma(4.0),
m_RangeSigma(50.0),
m_NumberOfRangeGaussianSamples(100u)
{
...
void ITKBilateralImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKBilateralImage::dataCheck()
{
  ...
  CheckIntegerEntry<unsigned int,double>(m_NumberOfRangeGaussianSamples, "NumberOfRangeGaussianSamples");
