...
void ITKMorphologicalGradientImage::CheckIntegerEntry(SubsType value, QString name)
{
...
//
// -----------------------------------------------------------------------------
void ITKMorphologicalGradientImage::dataCheckInternal()
{
...
void ITKMorphologicalGradientImage::filter()
{
  ...
  //define filter
  typedef itk::MorphologicalGradientImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Morphological Gradient Image Filter (KW)"; }
