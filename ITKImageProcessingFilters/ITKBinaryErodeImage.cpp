...
#include "moc_ITKBinaryErodeImage.cpp"
...
void ITKBinaryErodeImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKBinaryErodeImage::filter()
{
  ...
  //define filter
  typedef itk::BinaryErodeImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Binary Erode Image Filter (KW)"; }
