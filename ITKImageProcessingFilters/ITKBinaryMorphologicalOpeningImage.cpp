...
#include "ITKBinaryMorphologicalOpeningImage.h"
...
#include "moc_ITKBinaryMorphologicalOpeningImage.cpp"
...
void ITKBinaryMorphologicalOpeningImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKBinaryMorphologicalOpeningImage::filter()
{
  ...
  //define filter
  typedef itk::BinaryMorphologicalOpeningImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Binary Morphological Opening Image Filter (KW)"; }
