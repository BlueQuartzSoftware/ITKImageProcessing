...
void ITKBlackTopHatImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKBlackTopHatImage::filter()
{
  ...
  //define filter
  typedef itk::BlackTopHatImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Black Top Hat Image Filter (KW)"; }
