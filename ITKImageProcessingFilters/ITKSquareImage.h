...
public:
  ...
  SIMPL_FILTER_NEW_MACRO(ITKSquareImage)
  SIMPL_TYPE_MACRO_SUPER_OVERRIDE(ITKSquareImage, AbstractFilter)
...
private:
  ...
  void operator=(const ITKSquareImage&) = delete;    // Move assignment Not Implemented
};
