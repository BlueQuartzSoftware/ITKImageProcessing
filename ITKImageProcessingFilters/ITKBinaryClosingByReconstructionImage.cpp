...
#include "ITKBinaryClosingByReconstructionImage.h"
...
#include "moc_ITKBinaryClosingByReconstructionImage.cpp"
...
void ITKBinaryClosingByReconstructionImage::CheckIntegerEntry(SubsType value, QString name)
{
...
void ITKBinaryClosingByReconstructionImage::filter()
{
  ...
  //define filter
  typedef itk::BinaryClosingByReconstructionImageFilter<ImageType, ImageType> FilterType;
...
{ return "[ITK] ITK  Binary Closing By Reconstruction Image Filter (KW)"; }
