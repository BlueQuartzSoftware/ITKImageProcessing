...
#include "moc_ITKConnectedComponentImage.cpp"
...
void ITKConnectedComponentImage::CheckIntegerEntry(SubsType value, QString name)
{
...
{ return "[ITK] ITK  Connected Component Image Filter (KW)"; }
