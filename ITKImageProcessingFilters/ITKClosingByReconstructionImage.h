 ...
 */
class ITKClosingByReconstructionImage : public ITKImageProcessingBase
{
  Q_OBJECT
  PYB11_CREATE_BINDINGS(ITKClosingByReconstructionImage SUPERCLASS ITKImageProcessingBase)
