// This is core/vnl/algo/fft_amoeba.h
#ifndef fft_amoeba_h_
#define fft_amoeba_h_
//:
// \file
...
class ITKImageProcessing_EXPORT fft_amoeba
{
public:
  int verbose;
  int maxiter;
  ...
  fft_amoeba(vnl_cost_function& f);
...
struct fft_amoeba_SimplexCorner
{
  vnl_vector<double> v;
  double fv;
