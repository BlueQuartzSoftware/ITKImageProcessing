...
namespace itk
{
  ...
  const std::string
    FFTAmoebaOptimizer::GetStopConditionDescription() const
  {
  ...
  void
    FFTAmoebaOptimizer::PrintSelf(std::ostream & os, Indent indent) const
  {
  ...
  FFTAmoebaOptimizer::MeasureType
    FFTAmoebaOptimizer::GetValue() const
  {
  ...
  /** Get the Optimizer */
  fft_amoeba *
    FFTAmoebaOptimizer::GetOptimizer() const
  {
    return this->m_VnlOptimizer;
  }

  void
    FFTAmoebaOptimizer::SetInitialSimplexDelta(ParametersType initialSimplexDelta, bool automaticInitialSimplex)
  {
  ...
  void
    FFTAmoebaOptimizer::SetCostFunction(SingleValuedCostFunction * costFunction)
  {
  ...
  void
    FFTAmoebaOptimizer::StartOptimization()
  {
    ...
    else if(static_cast<unsigned int>(this->m_VnlOptimizer->get_num_evaluations()) < this->m_MaximumNumberOfIterations)
    {
      this->m_StopConditionDescription << "Fractional tolerance ("
        ...
        << ") has been met in " << this->m_VnlOptimizer->get_num_evaluations()
        << " iterations.";
    }
    else
    {
  ...
  void
    FFTAmoebaOptimizer::ValidateSettings()
  {
